...
function IconPortfolio({ iconPosition = { right: '20px', bottom: '20px' }, menuPosition = { right: '20px', bottom: '80px' } }) {
  ...
  const menuItems = [
    { title: 'Desain Grafis ', targetId: 'portfolio' },
    { title: 'Web Devloper', targetId: 'academy' },
