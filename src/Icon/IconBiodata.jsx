...
function IconBiodata({ iconPosition = { right: '20px', bottom: '20px' }, menuPosition = { right: '20px', bottom: '80px' } }) {
  ...
  const menuItems = [
    { title: 'Profile ', targetId: 'profile' },
    { title: 'S1', targetId: 's1' },
    { title: 'SMK', targetId: 'smk' },
    { title: 'SMP', targetId: 'smp' },
    { title: 'SD', targetId: 'sd' },
